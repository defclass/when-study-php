...
if (is_file(dirname(__FILE__).'/template.error.php')){
	...
	define('ET_E_not_exist3',	'<br>Sorry, Error or complicated  error exists in ');
	...
	define('ET_E_routing',		'Please set template config WebURL adds.<br>Example: $tpl = new template( array( "WebURL" => "http://www.rongyitou.com/" ) );');
